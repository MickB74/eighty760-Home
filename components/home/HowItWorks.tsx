...
const steps = [
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-energy-green">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                        {steps.map((step, index) => (
                            <div key={step.id} className="relative flex flex-col items-center text-center p-4 bg-white dark:bg-slate-900 rounded-lg shadow-sm lg:shadow-none lg:bg-transparent lg:dark:bg-transparent z-10">
                                <div className="w-16 h-16 rounded-full bg-white dark:bg-slate-800 border-2 border-energy-green flex items-center justify-center mb-6 shadow-sm">
                                    {step.icon}
                                </div>
