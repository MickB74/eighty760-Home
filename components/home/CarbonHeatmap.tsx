        ...
        <div className={`relative ${className}`}>
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl p-6">
                <div className="flex items-start justify-between mb-4">
                    <div>
                        <h3 className="text-lg font-semibold text-white mb-1">Hourly Carbon Intensity</h3>
                        <p className="text-sm text-slate-400">24/7 Grid Analysis</p>
                    </div>
                ...
                <div className="text-center mt-2 text-xs text-slate-500">Hour of Day</div>
            </div>
