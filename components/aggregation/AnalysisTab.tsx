...
export default function AnalysisTab({ result }: AnalysisTabProps) {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {/* 5. Asset Financial Breakdown (Moved from Dashboard) */}
            {result.asset_details && result.asset_details.length > 0 && (
                <div className="bg-white/5 backdrop-blur-md rounded-xl border border-white/10 p-6 shadow-sm overflow-x-auto">
