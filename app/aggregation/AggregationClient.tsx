    ...
    return (
        <main className="min-h-screen bg-white dark:bg-navy-950 transition-colors duration-300">
            ...
            <div className="w-full max-w-[1800px] mx-auto p-4 lg:p-6 pb-24">
                ...
                {/* Tab Navigation */}
                <div className="sticky top-[192px] md:top-[232px] z-40 bg-gray-50 dark:bg-navy-950 flex border-b border-gray-200 dark:border-white/10 mb-8 overflow-x-auto pt-2">
                    <button
