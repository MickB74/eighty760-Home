                                        ...
                                        <table className="w-full text-sm">
                                            <tbody>
                                                ...
                                                <tr className="border-b border-white/10">
                                                    ...
                                                    <td className={`py-3 text-right font-bold text-lg ${-result.total_cost_net >= 0 ? 'text-green-600' : 'text-red-500'}`}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className={`py-3 text-right ${-result.avg_cost_per_mwh >= 0 ? 'text-green-600' : 'text-red-500'}`}>
